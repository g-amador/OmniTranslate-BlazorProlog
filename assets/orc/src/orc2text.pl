...
%ALFABETO ORC
%a,b,c,d,f,g,h,i,k,l,m,n,o,p,r,s,t,u,x

caracter(Caracter) --> [X], {\+member(X,"ejqvwyz"), atom_codes(Caracter,[X])}.

palavra(Palavra) --> sequencia(L), {atom_chars(P,L), palavras_orc(Palavra,P)}.
...
%CONVERTER O ORC EM orc.txt PARA TEXTO EM text.txt
%:- descodifica('orc.txt','text.txt').
